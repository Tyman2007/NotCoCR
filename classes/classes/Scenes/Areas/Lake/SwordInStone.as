	...
	public class SwordInStone extends AbstractLakeContent
	{
		...
		private function tryToTakeSwordInStone():void 
		{
			...
			else 
			{
				...
				outputText("Suddenly, an immense light shines and nearly blinds you, emminating from the blade. As the light disperses, you begin to see the blade is completely rusted and in no real usable shape. Although, it's better than nothing, it will certainly need a very powerful being to repair it.\n\n", false);
				dynStats("lib", -(player.lib/3), "lus", -15);
				inventory.takeItem(weapons.U_SWORD, camp.returnToCampUseOneHour);
