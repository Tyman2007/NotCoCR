package classes.Scenes.Areas.HighMountains 
{
	...
	public class Izumi extends Monster
	{
		...
		public function titSmotherWait():void
		{
			...
			if (flags[kFLAGS.PC_FETISH] >= 2)
			{
				outputText(" and to be honest, her grip isn't an entirely unpleasent experience, either.  If only Izumi would stop playing around and just <i>take you</i> already.");
				game.dynStats("lus", 5);
			}
			else
			{
