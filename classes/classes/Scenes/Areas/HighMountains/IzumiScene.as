package classes.Scenes.Areas.HighMountains 
{
	...
	{
		private var izumiApologies:int = 0;
		...
		public function enterAfterMet():void
		{
			...
			if((player.str <= 75 && player.tallness < 108) || (player.str <=50 && player.tallness >= 108))
				addButton(1, "Surrender", fuckhugeOniGetsWhatSheWants);
			else
				addButton(1, "Fuck her", fuckhugeOniGetsWhatIWant);
			addButton(2, "Flee", fuckinChegIt);

			if (flags[kFLAGS.IZUMI_LOSSES] < 2)
			{
				...
				if (flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 1) {
					...
					addButton(3, "Apologize", apologizeLikeAMan);
				}
				else {
...
//“<i></i>”
		protected function apologizeLikeAMan():void
		{

			clearOutput();
			if(izumiApologies == 0) {
				outputText("You look to her, and make your best attempt at an earnest apology.\n\n");
				outputText("“<i>w..what?</i>”she says, looking at you with a puzzled expression on her face.\n\n");
				outputText("Then, after a brief pause, she bursts out in a very loud laugh, only further accentuated from the echoing on the cave walls. You can clearly see the giggling of her enormous breasts underneath her kimono as she laughs. You're drawn back a bit from the unexpected response to ponder what could be so funny about the situation.  \n\n“<i> It will take a little more than a simple apology for me. I already told you. I'm not forgiving you until I've made you feel as humiliated as I did.</i>”\n\n");
				outputText("Izumi readies herself, looking more determined than ever. “<i>Come at me" + this.heightDesc() + "</i>. I want to see the humiliated look in your eyes when I make you cum.”");
				addButton(1, "Let her", surrenderLikeAGirl);
				izumiApologies++;
			} else if(izumiApologies >= 1) {
				outputText("Thinking back on the failure of the first apology, you realise that you're going to have to try a different tactic.\n\n");
				outputText("You look at her and say “<i>I really do want to apologize, but it doesn't look like you will listen to me, so how about we make it interesting.</i>”\n\n");
				outputText("Izumi looks at you with a slight interest in where you're going with this. “<i>Alright, come sit with me.</i>”She becons you to a nearby rock as she crosses her arms over her magnificent mountains, waiting patiently for what you have to say.\n\n");
				outputText("You begin to explain that you will be battling to see who is the winner. If she wins, she can do whatever she wants to you, and you won't resist. If you win, she has to accept your apology and hear you out.\n\n");
				outputText("Her jaw drops as she looks at you in a mix of astonishment and disbelief. “<i>You... You're serious? That's it? Ha!</i>”She tears off her kimono, revealing the massive melons they were concealing, and exposing her hairless, wet pussy to you.\n\n");
				outputText("“<i>You said you wanted to make it interesting. I feel like I'm getting away with too much on this deal. Bring it on!</i>”\n\n");
			}
		...
		protected function surrenderLikeAGirl():void
		{
			clearOutput();

			outputText("You drop your guard and open your arms, offering your body in apology.");
			outputText("\n\nIt takes a second for Izumi to process your actions.");
			outputText("\n\nWhen she realizes what you are trying to do, her look of determination fades immediately, and quickly turns into that of pure annoyance. She lets out a loud grunt as she slams her fist into the cave wall, causing it to crumble slightly before turning back to you. \n\n");
			outputText("“<i>Hrmph.. Now how in the hell am I supposed to react to that? I'm an oni, it doesn't mean anything to me if you just throw yourself at me like a whore. Go home " + this.heightDesc() + ". Even if I was in the mood, I'm not anymore.</i>”She hastily turns around and begins walking back into her tent, still upset. \n\n");
			outputText("You find it best to just leave her be and make your way back to camp.");
		...
		//	{
				...
				if (player.str >= 75)
				{
					outputText("Putting your shoulder to the stone and begin to push, trying to roll it out of the way. It's no trouble at all with your powerful arms. It slides across a well established rut and clearly has been moved many times.\n\n");
				}
				// Low strength variant
				else if (player.str >=50)
				{
					outputText("Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists, but after a bit of tough pushing, it finally moves out of the way.\n\n");
				}
				else
				{
					outputText("Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists strongly. Your [feet] scramble about in the ground, unable to put the force needed to move the boulder.\n\n");
				}

				// Shared
				if (player.tallness >= 108) outputText("The humming stops almost instantly, and moments later a hand suddenly rests itself on the rock in front of you.  Looking up from your exertions, you find yourself face to face with a woman.  It takes a moment, but then you realize, you really are actually face to face with her - she’s as tall as you are!\n\n");
				else outputText("The humming stops almost instantly, and moments later a hand suddenly rests itself on the rock in front of you.  Looking up from your exertions, you find yourself face to face with a woman.  It takes a moment, but as her full form begins to reveal itself to you, she towers over you!\n\n");
				...
				outputText("“<i>Well now,</i>” she drawls in a syrupy, seductive tone, twirling an errant lock of her hair thoughtfully in her fingers.  “<i>You’re a </i>tough<i> one, aren’t you? ");
				if (player.str >= 50) outputText("Forcing");
		...
		//	}
			...
			if (player.tou <= 50) outputText(" and of course, that obnoxiously endurance-sapping heat");
			outputText(".\n\n");
		...
		/*	if (player.tallness < 108)
			...
			if (player.tou < 30) outputText(" causes you to cough and splutter.\n\n");
			...
			if (player.tou < 30) outputText(", kid. Let");
			else outputText(", let");
		...
		protected function enterFirstTimePartII():void
		{
			...
			outputText("Still");
			if (player.tou < 30) outputText(" struggling with");
			...
			if (player.str <= 50) outputText("  To your amazement, the boulder begins to move, and as more light - along with a much-needed rush of fresh air - floods into the smoky cavern, you see she’s actually rolling it aside with her <i> bare hands </i>.  Even given her great size, this woman’s strength must be immense!\n\n");
			else if (player.str <= 75)outputText("  The boulder begins to move, and as more light - along with a welcome rush of fresh air - floods into the smoky cavern, you see she’s rolling it aside with nothing more than her bare hands with graceful, if unnerving, ease.\n\n");
			else outputText("  The boulder begins to move, and as more light - along with a welcome rush of fresh air - floods into the smoky cavern.\n\n");
			...
			if (player.str <= 50 || player.tallness < 96) outputText(" You can’t help but feel like a sheep yourself - one who’s just noticed the wolf is staring it down.\n\n");
		...
		protected function smokeThePipe():void
		{
			...
			if (player.tou <= 30) outputText(" you cough and splutter");
			else if (player.tou < 60) outputText(" you flinch, holding back a cough");
			...
			if (player.tou <= 70) outputText("  After a while, you find it hard to even raise your arms to reach for the pipe again.\n\n");
			else outputText("\n\n");
		...
		protected function smokeJoins():void
		{
			...
			if (player.str <= 50 || player.tou <= 50 || (player.tallness <= 96 && player.str <=75)) outputText("  You swallow, hard, suddenly feeling oddly nervous.");
			...
			if((player.str <= 75 && player.tallness < 108) || (player.str <=50 && player.tallness >= 108))
				...
				outputText("You could let her continue with whatever it is that she’s planning, seeing how she wouldn't pose too serious of a threat to someone of your calibre.  On the other hand, you could just try to beat some sense into her, or possibly just shove her out of your way and leave; If there's anything you're certain of, the time for polite conversation is done.\n\n");
			menu();
			addButton(0, "Fight", fightTheFuckhugeOni);
			if((player.str <= 75 && player.tallness < 108) || (player.str <=50 && player.tallness >= 108))
				addButton(1, "Surrender", fuckhugeOniGetsWhatSheWants);
	...
	protected function fuckhugeOniGetsWhatIWant():void
	{
		hideUpDown();
		...
		if (player.hasCock())
		{
			outputText("You decide it will be fun to play around with someone of her size for a bit, and you open yourself up to her.  Her face splits into a truly lascivious grin and she licks her lips, hungrily.\n\n");
//“<i></i>”
			outputText("“<i>Yeah, that’s what I thought.</i>”  She smirks.  “<i>You just do exactly what I say, when I say, and nothing bad will happen to you.  Well... Nothing <i>too</i> bad, anyway.</i>”\n\n");

			outputText("Knowing there's nothing that she could really do to hurt you anyway, you decide to play along.\n\n");

			outputText("Suddenly, she lunges forwards, one enormous hand planting itself onto your");
			if (player.isTaur()) outputText(" flank and forcing you sideways onto the ground.");
			else outputText(" chest and forcing you backwards onto the ground.");
			outputText("  You giggle from the sudden movement and lay back, Izumi restraining you with a single well-muscled arm.  “<i>Well now, let’s see what we’re workin’ with here, shall we?</i>” she announces casually, as she pulls aside your [armor] to reveal your cock.\n\n");
		...
		{
			surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp2();
		}
		// Genderless
		else
		{
		...
		protected function surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp2():void
		{
			outputText("You decide it would be fun to have sex with someone of her size, and knowing how conciderably weaker she is than you, you decide to play along. You reach to start removing your [armorname]");
			...
			if (flags[kFLAGS.IZUMI_TIMES_SUBMITTED] == 0)
			{
				...
				outputText("“<i>Not so fast, I’ve never really had a chance to play with a girl before.  I wanna take my time on this one...</i>” She says.  Smiling suggestively, she reaches out and slowly divests you of your [armorname].");
				if (player.cor <= 33) outputText("  You can’t help but feel a slight sense of embarrassment as a strange woman undresses you, and you look away, embarrassed, while Izumi’s hands explore your body.");
				else if (player.cor >= 66) outputText("  As Izumi slowly reveals your naked body to the world, you begin to feel an oh-so-familiar heat building up inside of you.  You look down at Izumi with pride as she inspects your body, running a skillful hand over your chest with a thoughtful look on her face.");
				outputText("\n\n");
				...
				if (player.biggestTitSize() >= 15)
				{
					...
					if (player.cor < 50)
					{
						outputText("You nod as Izumi manhandles your massive mammaries as though looking for evidence of their falseness.  She bites her bottom lip, glaring intently at you as she roughly runs her hands over your breasts.  Although the Oni woman’s palms are surprisingly soft, her treatment of your breasts is not - she practically mauls you, squeezing, groping, even pinching the soft flesh.\n\n");

						outputText("“<i>Unbelievable...</i>” She mutters to herself, bitterly.  She looks up at you, confusion still plain upon your face, then scowls.  “<i>You don’t even know why I’m annoyed, do you?  Does having a chest THIS huge,</i>” she reaches out and pinches one of your [nipples] between her thumb and forefinger, causing you to yelp in surprise.  “<i>Just seem normal to you?!</i>”  She grumbles in frustration before giving the nipple a sharp tug, causing you to cry out once again.  “<i>Forget it.</i>”\n\n");
					}
					// High(er) corruption
					else
					{
			...
			if (flags[kFLAGS.PC_FETISH] >= 1)
			{
				outputText("While Izumi takes her time freeing you of your [armor], you experience a little familiar thrill as Ceraph’s cursed piercings start to work their magic.  Every inch of your skin from head to foot tingles with excitement as you relish the prospect of finding yourself on display once again, naked for the whole world to stare, or scowl, or leer - it makes your nipples harden just thinking about it.\n\n");
				...
				outputText("“<i>Look, "+ this.heightDesc() +", I know I’m kind of an intimidating specimen, but you don’t really need to be scared.</i>” She smirks.  “<i>You keep shivering in fear like that and I’m liable to take offence, yeah?</i>”  You blink again in confusion before realization finally dawns. She thinks you're shivering in fear.  Izumi has absolutely no idea how much this is turning you on.  The idea of your secret arousal going completely unnoticed is surprisingly erotic, and that thought turns out to be just enough to push you over the edge.  You wince and bite your lip to stifle your moans, quivering in the throes of a miniature orgasm, even though you’ve really yet to be even touched... and on a whim, you decide to keep eye contact with Izumi for the entire thing.\n\n");
			...
			if (!player.isTaur())
			{
				outputText("Without warning, Izumi violently lunges forward, grabbing at you.  You are only able to let out a surprised yelp before she grips onto your arms, pulling you towards her and spinning you around.");
				if (!player.isNaga()) outputText("  Before you know it, she has you down on your knees, the cold stone of the floor digging into your [skinfurscales] a little as she circles behind you, smirking cruelly.");
				else outputText("  She takes hold of your shoulders and tries to force force you lower to the ground, as you willingly let her, forced to slither more and more of your tail out from under yourself, until Izumi towers over you.  She circles behind you, a cruel smirk the only hint of her intentions.");
				outputText("\n\n");
				...
				outputText("“<i>Well now, let’s see...</i>” She murmurs into your ear, softly.  “<i>What can I possibly do with you, hmm?</i>”  She jerks you  back upright, locking your arm behind you as she frogmarches you towards the entrance to her cave.  “<i>You’re really pretty, you know that?</i>”  She purrs.  “<i>It’d be a shame to hide such a pretty thing away in a dark place like this, wouldn’t it?</i>”\n\n");

				outputText("At the entrance to the cave, you let out a grunt as you find yourself being yanked backwards into Izumi’s lap.  Her legs entwine with yours, yanking them apart, exposing your [vagina] to the cold mountain winds.  At the same time, she grips both your wrists with one hand, pulling them behind your back, forcing you to arch backward, and thrusting your [fullchest] out for inspection.  You gasp in surprise as you feel her other hand reach around to grope at your breasts, squeezing and massaging them experimentally.  Despite yourself, you can’t help but let out a yelp as she squeezes a [nipple] between thumb and forefinger.\n\n");

				outputText("You squirm in pleasure Izumi’s grip, loving the new sensations from the cold wind across your glitstening pussy.\n\n");
			}
			// Taur variant
			else
			{
				outputText("Without warning, Izumi violently lunges forward, a hop in her step easily launching her high enough to land on top of your [race]-like body.  You’re only able to let out a surprised yelp before she grabs your arms, pulling them behind your back as a makeshift set of reins, a single powerful hand clasped around your wrists to keep them restrained.  The effect of giving control to the Oni only reassured by the sensation of her muscular thighs clamped tightly around your flanks.\n\n");

				outputText("Izumi reaches around from behind you and you half turn to look at her, but she grips you by the chin with her free hand and firmly turns your head away from her.  Your gaze flits nervously around the cave at random as you feel Izumi’s feet run across your [skinfurscales], her toes squirming against your underbelly.\n\n");

				outputText("“<i>Well now, let’s see...”<i>  She murmurs, softly.  “<i>What can I possibly do with you, hmm?</i>”  She jerks your arms forward, elbows locked straight thanks to her iron-hard grip around your wrists.  The motion prompts you to stumble a half step forward, edging you closer to the entrance of her cave.  “<i>You’re really pretty, you know that?</i>”  She purrs.  “<i>It’d be a shame to hide such a pretty thing away in a dark place like this, wouldn’t it?</i>”\n\n");

				outputText("Struggling helplessly against the promise of pleasure the oni is about to bring, you gradually stagger over to the mouth of the cave under her direction, another jolt delivered to your arms whenever Izumi deems your progress too slow.  A gust of cold mountain air blows over you, chilling your [skinfurscales] and causing you to shiver as your nipples harden.  Izumi tugs backward on your ‘reins’ to stop your wobbling advance dead.  You gaze out at the scenery, the vast mountain range spread out below you, and for a moment you’re filled with amazement at the view peering over the cliffside.  Then, without warning, Izumi kicks your legs out from under you, forcing you to collapse to the floor with a surprised shriek.\n\n");
			...
			{
				menu();
				addButton(0, "ShowMeOff", surrenderFemaleExhibitionVariant2);
				addButton(1, "HideMe", surrenderFemaleNonExhibitionVariant2);
			}
			else
			{
				menu();
				addButton(0, "Next", surrenderFemaleNonExhibitionVariant2);
			}
		}

	// Female surrender, "regular" path
	protected function surrenderFemaleNonExhibitionVariant2():void
	{
		clearOutput();

		outputText("You effortlessly break out of Izumi's grip, taking her aback at your sudden display of strength. You grab a nearby rock and throw it into the group of onlookers, lodging the rock deep into a tree. The onlookers see this and disappear in a flurry of angry squawks and howls.\n\n");

		outputText("“<i>W..what?!</i>” She says in disbelief at your sudden exhibition of strength. You ignore her expression and throw yourself back into the position you just were in and guide her arms back to where they were.");

		outputText("As you lay back waiting for her look to subside, you gradually start seeing a huge smile break out of her face.  The smile soon becomes something more than friendly though, and suddenly Izumi’s head darts forwards and she forces her tongue into your surprised");
		if (player.hasMuzzle()) outputText(" maw");
		else outputText(" mouth");
		outputText(", stunning you as she launches into a powerful french kiss.  Her tongue wraps effortlessly around your own, leaving you breathless and unable to help but wonder how dextrous it could be.  Izumi assaults your mouth, forcefully,  Finally, she breaks off, leaving you gasping for breath after your extended tongue-grappling session.  For her part, Izumi seems to be none the worse for wear, wiping her mouth with a satisfied expression.\n\n");

		outputText("“<i>Mmm... If I'd known you were that strong I wouldn't have been so nice.</i>” Izumi murmurs.“<i>Now... where were we?</i>” You look down as she gently rolls a hand around to cup one of your breasts. “<i>Oh yeah,</i>” She adds, playfully. “I<i> remember...</i>” Izumi gropes at your chest experimentally, stroking, fondling, squeezing, molesting your bust as she gauges it for firmness.\n\n");
	...
	// Female surrender, ask player if which variant they want
	protected function surrenderFemaleExhibitionVariant2():void
	{
		clearOutput();
		...
		menu();
		addButton(0, "Yes", surrenderFemaleLookitYouTheCenterOfAttentionYouSlut2);
		addButton(1, "No", surrenderFemaleNonExhibitionVariant2); // Take the non-exhibitionist path
	}

	// Female surrender, Exhibitionist variant scene body
	protected function surrenderFemaleLookitYouTheCenterOfAttentionYouSlut2():void
	{
		outputText("You nod your head vigorously at the idea of getting some of your beloved audience actually involved.  Izumi chuckles again.\n\n");
