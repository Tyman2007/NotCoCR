	...
	{	
		...
		public function doubleAttackOptions():void {
			...
			if (flags[kFLAGS.DOUBLE_ATTACK_STYLE] == 0) {
				outputText("You will currently always double attack in combat.  If your strength exceeds seventy-five, your double-attacks will be done at seventy-five strength in order to double-attack.");
				outputText("\n\nYou can change it to double attack until seventy-five strength and then dynamicly switch to single attacks.");
				outputText("\nYou can change it to always single attack.");
			}
			else if (flags[kFLAGS.DOUBLE_ATTACK_STYLE] == 1) {
				outputText("You will currently double attack until your strength exceeds seventy-five, and then single attack.");
				outputText("\n\nYou can choose to force double attacks at reduced strength (when over seventy-five, it makes attacks at a strength of seventy-five.");
				outputText("\nYou can change it to always single attack.");
			}
			else {
				outputText("You will always single attack your foes in combat.");
				outputText("\n\nYou can choose to force double attacks at reduced strength (when over seventy-five, it makes attacks at a strength of seventy-five.");
				outputText("\nYou can change it to double attack until seventy-five strength and then switch to single attacks.");
			}
